...
namespace Unalive_WebManagement.BLL.Interfaces
{
    ...
    public interface IUserService
    {
        ...
        Task<long> GetRankPointAsync(int userId);
        Task<long> UpdateRankPointAsync(int userId, long points, bool isAddition);
        ...
        Task<UserItemDto> CreateUserItemNoOrderAsync(CreateUserItemNoOrderDto dto);
